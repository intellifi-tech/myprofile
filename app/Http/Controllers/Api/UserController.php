...
class UserController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $profileImageName = "https://demo.intellifi.tech/demo/MyProfile/web/public/".remove_turkish(lower_case_turkish($request->name.'-'.$request->surname)).chr(rand(65, 90)).chr(rand(65, 90)).rand(10, 99).'.'.'png';
        ...
        $coverImageName = "https://demo.intellifi.tech/demo/MyProfile/web/public/".remove_turkish(lower_case_turkish($request->name.'-'.$request->surname)).chr(rand(65, 90)).chr(rand(65, 90)).rand(10, 99).'.'.'png';
