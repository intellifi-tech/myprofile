...
class UserController extends Controller
{
    ...
    {
        $users = User::with(['company', 'userExperiences', 'userAttendedEvents', 'userPrivacy'])->get();
...
//        })->first();
        ...
        $eventsAttended = UserAttendedEvent::where('user_id', $id)->orderBy('created_at', 'DESC')->get(); // Katıldığı etkinlikler
        dd($eventsAttended);
    ...
    public function edit($id)
    {
        ...
        return view('admin.user.edit', ['page' => $this->page, 'user' => $user, 'comments' => $comments, 'follow' => $follow, 'eventsAttended' => $eventsAttended]);
    }
