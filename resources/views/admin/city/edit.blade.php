                ...
                <div class="col-md-6 col-md-offset-2">
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        ...
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                            {!! Form::open(['class' => 'form-horizontal', 'action' => ['Admin\CityController@update', $city->id], 'method' => 'PUT']) !!}
                            <div class="form-body">
                                <div class="form-group form-md-line-input">
                                    {!! Form::label('name', 'İl', ['class' => 'col-md-3 control-label'])  !!}
                                    <div class="col-md-9">
                                        {!! Form::text('name', $city->name, ['id' => 'name', 'class' => 'form-control', 'required' => true]) !!}
