    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="{{ action('Admin\TownController@index') }}">{{ $page['title'] }}</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                ...
                <div class="col-md-6 col-md-offset-2">
                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        ...
                        <div class="portlet-body">
                            <!-- BEGIN FORM-->
                            {!! Form::open(['class' => 'form-horizontal', 'action' => ['Admin\TownController@update', $town->id], 'method' => 'PUT']) !!}
                            <div class="form-body">
                                <div class="form-group form-md-line-input">
                                    {!! Form::label('name', 'İlçe', ['class' => 'col-md-3 control-label'])  !!}
                                    <div class="col-md-9">
                                        {!! Form::text('name', $town->name, ['id' => 'name', 'class' => 'form-control', 'required' => true]) !!}
